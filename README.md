...
- **Canon**: `/canon` publishes settled nodes straight from source
...
│   │   ├── canon/                   # Canonical nodes, published straight from source
...
├── docs/canonical/                  # Markdown source for canonical nodes (served at /canon)
├── public/
